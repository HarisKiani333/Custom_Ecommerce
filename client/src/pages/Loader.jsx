...
const Loader = ({
  ...
  const getLoadingMessage = () => {
    ...
    switch (type) {
      case 'payment':
        return isPaymentFlow ? 'Processing your payment...' : 'Processing transaction...';
      case 'navigation':
        return 'Loading page...';
      case 'data':
        return 'Loading data...';
      case 'custom':
        return 'Please wait...';
      default:
        return nextPage === 'my-orders' ? 'Processing your payment...' : 'Redirecting...';
    }
  };
  ...
  const renderSpinner = () => {
    ...
    switch (variant) {
      case 'pulse':
        return (
          <div className={`${sizeClasses} bg-green-600 rounded-full animate-pulse mx-auto`}></div>
        );
      ...
      default: // 'spin'
        return (
          <div className={`animate-spin rounded-full ${sizeClasses} border-b-2 border-green-600 mx-auto`}></div>
        );
    }
  };
